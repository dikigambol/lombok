...
$txtcb = isset($_POST['txtCB']) ? $_POST['txtCB'] : $result['CB'];
?>
                  ...
                  <form name="form1" method="post" action="rulesEditFungsi.php">
                    <table class="table">
                        ...
                        <tr>
                            <td>CB</td>
                            <td>
                                <input name="txtCB" type="hidden" maxlength="3" size="6" value="<?php echo $txtcb; ?>" placeholder="">
                                <label><?php echo $txtcb;?></label>
                            </td>
                        </tr>
                        <tr>
                            <td>&nbsp;</td>
