<?php
    ...
    function AddcbYGejala($id_gejala, $noID){
        include "koneksi.php";
        $sql_cb = "INSERT INTO tmp_cb (id_gejala,noID,ket) 
                        VALUES ('$id_gejala','$noID','y')";
        mysqli_query($koneksi, $sql_cb);    
    }
    function AddcbNGejala($id_gejala, $noID){
        include "koneksi.php";
        $sql_cb = "INSERT INTO tmp_cb (id_gejala,noID,ket) 
    ...
    if ($rbPilih == "ya"){
        ...
        echo "<meta http-equiv='refresh' content='0; url=index.php?page=cbKonsul'>";
    }
    if ($rbPilih == "tidak"){
