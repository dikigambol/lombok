<?php
    ...
    elseif($page == "cbKonsul"){
        if(file_exists("cbKonsul.php")){
            include "cbKonsul.php";
        }
        else{
            echo"file cbKonsul tidak ditemukan!";
        }
    }
    elseif($page == "cbCek"){
        if(file_exists("cbCek.php")){
            include "cbCek.php";
        }
        else{
            echo"file cbcek tidak ditemukan!";
        }
    }
    elseif($page == "hasil"){
