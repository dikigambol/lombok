...
if ($result_cekh == 1){
    ...
    function Deltmpcb($noID){
        include "koneksi.php";
        $sql_delcb = "DELETE from tmp_cb where noID='$noID'";
        mysqli_query($koneksi, $sql_delcb);
    }
...
<body>
<div class="container">
    <form action="?page=cbCek" method="post" name="form1" target="_self">
        <div>
            <br><br><br>
